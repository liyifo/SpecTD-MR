...
class SetGNNExtended(nn.Module):
    ...
    def forward(self, data, edge_weight=None, edge_rel_bias=None):
        ...
        concept_count = int(edge_index[1].min().item())
        edge_index[1] -= concept_count
        hyperedge_count = int(edge_index[1].max().item()) + 1
